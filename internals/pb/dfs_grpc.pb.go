...
const (
	DistributedFileSystem_RegisterDataNode_FullMethodName      = "/dfs.DistributedFileSystem/RegisterDataNode"
	DistributedFileSystem_SendFileList_FullMethodName          = "/dfs.DistributedFileSystem/SendFileList"
...
type DistributedFileSystemClient interface {
	...
	SendFileList(ctx context.Context, in *SendFileListRequest, opts ...grpc.CallOption) (*SendFileListResponse, error)
...
func (c *distributedFileSystemClient) RegisterDataNode(ctx context.Context, in *RegisterDataNodeRequest, opts ...grpc.CallOption) (*RegisterDataNodeResponse, error) {
	out := new(RegisterDataNodeResponse)
	err := c.cc.Invoke(ctx, DistributedFileSystem_RegisterDataNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *distributedFileSystemClient) SendFileList(ctx context.Context, in *SendFileListRequest, opts ...grpc.CallOption) (*SendFileListResponse, error) {
	out := new(SendFileListResponse)
	err := c.cc.Invoke(ctx, DistributedFileSystem_SendFileList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DistributedFileSystemServer interface {
	...
	// Data node sends its file list to the master
	SendFileList(context.Context, *SendFileListRequest) (*SendFileListResponse, error)
	// Check if the data node is alive
...
func (UnimplementedDistributedFileSystemServer) RegisterDataNode(context.Context, *RegisterDataNodeRequest) (*RegisterDataNodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterDataNode not implemented")
}
func (UnimplementedDistributedFileSystemServer) SendFileList(context.Context, *SendFileListRequest) (*SendFileListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendFileList not implemented")
}
...
func _DistributedFileSystem_RegisterDataNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterDataNodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DistributedFileSystemServer).RegisterDataNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DistributedFileSystem_RegisterDataNode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DistributedFileSystemServer).RegisterDataNode(ctx, req.(*RegisterDataNodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DistributedFileSystem_SendFileList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendFileListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DistributedFileSystemServer).SendFileList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DistributedFileSystem_SendFileList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DistributedFileSystemServer).SendFileList(ctx, req.(*SendFileListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DistributedFileSystem_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _DistributedFileSystem_RegisterDataNode_Handler,
		},
		{
			MethodName: "SendFileList",
			Handler:    _DistributedFileSystem_SendFileList_Handler,
		},
		{
	...
	Metadata: "internals/proto/dfs.proto",
}
